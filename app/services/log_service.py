...
class LogService:
    ...
    @staticmethod
    def get_logs(filters: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        """
    ...
    @staticmethod
    def get_workflow_run_logs(workflow_run_id: str) -> List[Dict[str, Any]]:
        """
        ...
        response = supabase.table('logs').select('*').eq(
            'workflow_run_id', workflow_run_id
    ...
    @staticmethod
    def delete_old_logs(days_old: int = 30) -> bool:
        """
        ...
        response = supabase.table('logs').delete().lt('created_at', cutoff_iso).execute()
    ...
    def get_log_stats() -> Dict[str, int]:
        ...
        response = supabase.table('logs').select('event_type').gte(
    ...
    @staticmethod
    def get_log_analytics(hours: int = 24) -> Dict[str, Any]:
        """
        ...
        response = supabase.table('logs').select('*').gte(
    ...
    @staticmethod
    def get_error_logs(hours: int = 24, limit: int = 100) -> List[Dict[str, Any]]:
        """
